...
def main(username):
    global game_speed, x_pos_bg, y_pos_bg, points, obstacles, name
    run = True
    ...
    while run:
        for event in pygame.event.get():
            ...
            if event.type == pygame.KEYDOWN:
                ...
                username=""
                while username == "":
                    username = simpledialog.askstring(title="Name needed!",
        ...
        if death_count == 0:
            ...
            proof=pyautogui.screenshot('proof.png')
